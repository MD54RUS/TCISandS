...
public class VacancyServiceImpl implements VacancyService {
    ...
    public VacancyServiceImpl(VacancyRepository vacancyRepository, EmployerRepository employerRepository) {
...
//    }
    ...
    public int getVacancyCount(long specialisationId, long areaId) {
        return vacancyRepository.countBySpecialisationAndAreaId(specialisationId, areaId);
    }
